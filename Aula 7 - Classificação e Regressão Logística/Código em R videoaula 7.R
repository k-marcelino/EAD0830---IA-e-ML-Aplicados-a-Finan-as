...
# Aula 7 - Regress�o Log�stica
#
# --------------------------------------------

# Carregar pacotes:
library(caret) # t�cnicas classifica��o
library(readxl)
library(tidyverse) # fun��es para an�lise de dados
library(ROCR) 
...
count(DadosAula7,vars = Y)/nrow(DadosAula7) # frequ�ncia relativa
...
#No Information Rate -> melhor palpite quando n�o h� informa��es
#Assume classe de maior ocorr�ncia


# Sele��o aleat�ria amostras treino e teste:
